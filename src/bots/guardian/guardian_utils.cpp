...
int Guardian::get_sender_name() { return (get_word(1, sender_name, msg, " ")); }

int Guardian::get_word(size_t begin_pos, std::string& word_got, std::string str,
                       std::string last_char_to_find)
{
    size_t pos_end;
    std::string tmp;
