...
SRCS_COMMANDS = $(addprefix commands/, away.cpp join.cpp kick.cpp list.cpp mode.cpp names.cpp nick.cpp notice.cpp part.cpp pass.cpp ping.cpp privmsg.cpp quit.cpp user.cpp invite.cpp topic.cpp)
